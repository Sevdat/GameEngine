...
void AppWindow::onCreate()
{
    ...
    vertex vertex_list[] =
    {
        ...
        //FRONT FACE
        {
            Vector3D(-0.5f,-0.5f,-0.5f), Vector3D(0,0,0),  
            Vector3D(0,1,0) 
        },
        {
   ...
   // GraphicsEngine::get()->createShaders();
    ...
    m_vb->load(vertex_list, sizeof(vertex), size_list,
        shader_byte_code, size_shader
    );
...
void AppWindow::onUpdate()
{
 ...
 //   GraphicsEngine::get()->setShaders();
    ...
    GraphicsEngine::get()->getImmediateDeviceContext()->
        drawIndexedTriangleList(m_ib->getSizeIndexList(), 0,0);
