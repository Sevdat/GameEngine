...
LRESULT CALLBACK WndProc(
    ...
    case WM_DESTROY: {
        ...
        Window* window =
            (Window*)GetWindowLong(hwnd,GWL_USERDATA);                //dif GetWindowLongPtr
        window->onDestroy();
        ::PostQuitMessage(0);
        break;
    }
...
bool Window::init()
{
    ...
    m_hwnd = ::CreateWindowEx(
        ...
        L"DirectX Application",WS_OVERLAPPEDWINDOW, //WS_OVERLAPPEDWINDOW -> WS_CAPTION|WS_SYSMENU
...
void Window::setHWND(HWND hwnd)
{
    this->m_hwnd = hwnd;
                                    ...
                                    //void Window::onCreate()  void Window::onUpdate()
